...
这几年把写作公众号当做了一种业余的习惯和爱好，虽然没有成为大 V，但是出于整理自己的知识体系的目标也基本达到了。
...
我运营过领域驱动设计（DDD）社群，进行了大量的 DDD 实践和分享，和同事合作开发的 DDD 课程在 51CTO 上有 1.8W 学习者。
...
1️⃣ 小报童：《人生十问：自我认知的困难问题》

2️⃣ 小报童：《人生十问：社会的游戏规则》
...
4️⃣ 什么是组合发货？我们定义为：配件调拨单的执行，关注货物的内容，叫做 ShipmentItem。

通过关注点分离，实现了模型的职责单一，便于后续模型的拓展，例如 Shipment 可以被其它单据使用。

![领域建模](./consultant/models.png)
...
![系统设计](./consultant/system-design.png)
...
![技术管理](./consultant/tech-management.png)
