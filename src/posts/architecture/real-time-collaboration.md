...
互联网时代越来越多的实时协作软件出现，例如在线点餐、文档编辑、在线绘图。
...
点餐的场景下如何处理一致性？一般将业务操作原子化+幂等，把数据更新修改为加、减操作，使用最终一次性让服务器决策结果（发生冲突时，一般是先到先做策略，后到丢弃），并将事件分发到参与方。
...
![](./real-time-collaboration/event-scale.png)
